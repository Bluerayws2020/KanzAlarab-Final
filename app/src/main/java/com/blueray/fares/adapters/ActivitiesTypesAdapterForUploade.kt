...
import com.blueray.fares.databinding.ListUploadeBinding
import com.blueray.fares.model.DropDownModel

class ActivitiesTypesAdapterForUploade(
    var flag :Int ,
    var list: List<DropDownModel>,
    var onCategroryChose: OnCategroryChose
): RecyclerView.Adapter<ActivitiesTypesAdapterForUploade.MyViewHolder>()
{

    inner class MyViewHolder(val binding : ListUploadeBinding):ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val binding = ListUploadeBinding.inflate(LayoutInflater.from(parent.context),parent,false)
