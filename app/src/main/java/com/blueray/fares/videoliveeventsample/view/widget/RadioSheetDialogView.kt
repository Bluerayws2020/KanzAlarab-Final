package com.blueray.fares.videoliveeventsample.view.widget
...
import com.blueray.fares.databinding.ViewRadioSheetDialogBinding
import com.blueray.fares.databinding.ViewRadioSheetDialogItemBinding
...
internal class RadioSheetDialogAdapter(
    ...
    inner class ViewHolder(
        ...
        fun bind(item: TextBottomSheetDialogItem) {
            ...
            binding.rbRadioSheetDialogItem.isChecked = adapterPosition == selectedPosition
        }
    }
}
